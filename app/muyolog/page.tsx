...
export default function Muyolog() { 
    return <div className="text-center w-5/6 md:w-3/4 lg:w-1/2 mx-auto tracking-wider max-w-[720px]">
            ...
            <p className="hover:text-gray-500"><Link href="muyolog/espositos">- La MURGA!!</Link></p>
            <p className="hover:text-gray-500"><Link href="muyolog/mistique">- Mistique Vauban</Link></p>
            </div>
        </div>
}